    ...
    <div className="homePage">
      ...
      <section className="homeSection">
        <div className="homeFeature">
          <img src="src\images\search-media.png" alt="Search Media" className="featureImage" />
          <div>
        ...
        <div className="homeFeature">
          <img src="src\images\add-to-list.png" alt="Add to List" className="featureImage" />
          <div>
        ...
        <div className="homeFeature">
          <img src="src\images\ai-recommendations.png" alt="AI Recommendations" className="featureImage" />
          <div>
